    ...
    <div class="space-y-6">
        <header class="flex items-center justify-between gap-4 border-b border-white/15 pb-4">
            <div>
                ...
                <h1 class="text-xl md:text-2xl font-semibold tracking-tight text-white">Product Catalog &gt; Attributes</h1>
                <p class="mt-1 text-sm text-white/60">
                    Define custom fields such as Color, Size, and Material for your products.
                </p>
            </div>
            <a
        ...
        >
            <p class="text-sm text-white/70 text-center">
                Attribute management UI will appear here (attribute sets, values, and mappings).
            </p>
        </div>
    </div>
@endsection
