    ...
    <div class="space-y-6">
        <header class="flex items-center justify-between gap-4 border-b border-white/15 pb-4">
            <div>
                ...
                <h1 class="text-xl md:text-2xl font-semibold tracking-tight text-white">Product Catalog &gt; Brands</h1>
                <p class="mt-1 text-sm text-white/60">
                    Registry for manufacturers and brand identities across channels.
                </p>
            </div>
            <a
        ...
        >
            <p class="text-sm text-white/70 text-center">
                Brand registry UI will appear here (logo, origin, marketplace mapping, etc.).
            </p>
        </div>
    </div>
@endsection
