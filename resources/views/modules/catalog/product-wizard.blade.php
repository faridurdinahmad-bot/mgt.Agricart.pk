    ...
    <div class="space-y-6">
        <header class="flex items-center justify-between gap-4 border-b border-white/15 pb-4">
            <div>
                ...
                <h1 class="text-xl md:text-2xl font-semibold tracking-tight text-white">Product Catalog &gt; Add Product Wizard</h1>
                <p class="mt-1 text-sm text-white/60">
                    Multi-step wizard for adding products: General Info → Media → Variations → SEO → Sync Settings.
                </p>
            </div>
            <a
        ...
        >
            <p class="text-sm text-white/70 text-center">
                The step-based product creation form will be built here.
            </p>
        </div>
    </div>
@endsection
