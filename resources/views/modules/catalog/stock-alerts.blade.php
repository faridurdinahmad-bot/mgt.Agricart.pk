    ...
    <div class="space-y-6">
        <header class="flex items-center justify-between gap-4 border-b border-white/15 pb-4">
            <div>
                ...
                <h1 class="text-xl md:text-2xl font-semibold tracking-tight text-white">Product Catalog &gt; Stock Alerts</h1>
                <p class="mt-1 text-sm text-white/60">
                    Monitor low-stock and out-of-stock items across warehouses and channels.
                </p>
            </div>
            <a
        ...
        >
            <p class="text-sm text-white/70 text-center">
                Stock alert dashboards and thresholds will be configured here.
            </p>
        </div>
    </div>
@endsection
